...
const Analytics = ({ smallStats, fluid }) => (
  <Container fluid={fluid} className="main-content-container px-4">
    <Row noGutters className="page-header py-4">
      ...
      <Col xs="12" sm="4" className="col d-flex align-items-center">
        <ButtonGroup size="sm" className="d-inline-flex mb-3 mb-sm-0 mx-auto">
          <Button theme="white" tag={() => <b />} to="/analytics">
            Traffic
          </Button>
          <Button theme="white" tag={() => <b />} to="/ecommerce">
            Sales
          </Button>
        </ButtonGroup>
      </Col>
