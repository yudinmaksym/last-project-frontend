...
class ReportsEnergyConsumptionByLevel extends React.Component {
  constructor(props) {
    super(props)
...
ReportsEnergyConsumptionByLevel.defaultProps = {
  title: 'Sales Report',
  chartData: {
    labels: [
      '2014',
...
export default ReportsEnergyConsumptionByLevel
