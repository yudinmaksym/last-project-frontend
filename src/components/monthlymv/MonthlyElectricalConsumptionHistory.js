...
class MonthlyElectricalConsumptionHistory extends React.Component {
  static defaultProps = {
    type: 'bar',
  }
...
MonthlyElectricalConsumptionHistory.defaultProps = {
  title: 'Electrical Consumption History',
  extraValues: [],
  chartData: {
    datasets: [
      {
...
export default MonthlyElectricalConsumptionHistory
