...
import EDToolContainer from '../../src/containers/WTA/TabTwoContainer'
...
const CDToolPage = ({ project }) => (
  <Layout noFooter>
    <Head>
      <title>Walk Through Audit</title>
    </Head>
    <Container className="container--cd" fluid>
      <Row noGutters className="page-header py-4">
        <PageTitle title={project.name} className="text-sm-left mb-3" subtitle="Walk Through Audit" />
      </Row>
      <EDToolContainer id={project.id} name={project.name}/>
    </Container>
  </Layout>
)
